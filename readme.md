...
# Big-O 101: Understanding Time and Space Complexity
...
- Jump in to the [next lecture](https://github.com/aribrenner/Big-O-102)
...
* [P vs NP problem](https://en.wikipedia.org/wiki/P_versus_NP_problem)
  ...
  - Simply find a single poly-time algorithm for any [NP-complete problem](https://en.wikipedia.org/wiki/NP-completeness#NP-complete_problems)
    - you will **literally [win 1 million dollars](https://en.wikipedia.org/wiki/Millennium_Prize_Problems)** (probably more)
    - you will **literally [change the world](https://en.wikipedia.org/wiki/P_versus_NP_problem#Consequences_of_solution)**
